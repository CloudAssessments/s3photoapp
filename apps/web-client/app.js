...
const filterHost = process.env.FILTER_HOST || process.env.DOCKER_COMPOSE ? 'photo-filter' : 'localhost';
const filterPort = process.env.FILTER_PORT || '3002';
const storageHost = process.env.STORAGE_HOST || process.env.DOCKER_COMPOSE ? 'photo-storage' : 'localhost' ;
